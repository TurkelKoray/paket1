...
@section('content')
    ...
    <form id="form" action="/admin/gallerys/update/{{ $photo->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content pn br-n allcp-form theme-primary">
                    ...
                    <div class="section row mbn">
                        ...
                        <div class="col-md-12 mb15 ph10">
                            ...
                            <input name="name" type="text" class="gui-input form-control" value="{{ $photo->name }}" placeholder="Başlık">
                        </div>

                        <div class="col-md-12 mb15 ph10 none">
                            <label for="description" class="field prepend-icon mb5"> Açıklama </label>
                            <textarea class="gui-textarea form-control" id="description" name="description" placeholder="Açıklama">{{ $photo->description }}</textarea>
                            ...
                            <div class="section">
                                <label class="field select">
                                    <select id="state" name="state">
                                        ...
                                        <option @php if( $photo->state == 1 ){ echo "selected";} @endphp value="1">Yayınla</option>
                                        <option @php if( $photo->state == 0 ){ echo "selected";} @endphp value="0">Yayınlama</option>
                    ...
                    <div class="col-md-4">
                        <img class="img-responsive" src="{{ asset("uploads/photogallery/$photo->img") }}"
                    </div>
                </div>
            </div>
        </div>

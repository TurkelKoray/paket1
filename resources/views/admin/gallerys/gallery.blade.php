...
@section('content')
    ...
    <div class="panel-heading">
        <span class="panel-title hidden-xs">{{ $photo->name }} Foto Galeri </span>
    </div>

    <form id="form" action="/admin/gallerys/galleryadd/{{ $photo->id }}" method="post" enctype="multipart/form-data">
        ...
        @foreach($gallerys as $gallery)
            <div id="item-{{ $gallery->id }}" class="col-lg-3">
                <div  style="width: 100% ; height:200px;  border: 1px solid #eee;">
                    <img class="gallerySirala" src="{{ asset("uploads/photogallery/$gallery->img") }}" width="100%" height="200px">
                </div>

                <div style="width:50px; position:absolute; height:30px; margin-top:-200px; margin-left:5px; ">
                    <a style="color:red;" onclick="return siluyari();" href="{{ asset("/admin/gallerys/gallerySil/$gallery->id") }}"> <span class="fa fa-trash fa-2x"></span> </a>
                </div>
    ...
    <header id="topbar" class="ph10">
        <div class="topbar-left">
            <ul class="nav nav-list nav-list-topbar pull-left">
                <li>
                    <a href="/admin/gallerys/index">Foto Galeri Listesi</a>
                </li>
                <li class="active">
                    <a href="/admin/gallerys/create">Yeni Foto Galeri</a>
                </li>
            </ul>
        </div>

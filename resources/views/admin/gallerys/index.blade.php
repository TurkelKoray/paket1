...
@section('content')
    ...
    <div class="panel" id="spy3">
        <div class="panel-heading">
            <span class="panel-title">FOTO GALERİ</span>

        </div>

        <div id="gallerySirala" style="height:200px; position:relative;" class="rower">
            @foreach($photos as $photo)
                <div id="item-{{ $photo->id }}" class="col-lg-3">
                    <div  style="width: 100% ; height:200px;  border: 1px solid #eee;">
                        <img class="gallerySirala" src="{{ asset("uploads/photogallery/$photo->img") }}" width="100%" height="200px">
                    </div>

                    <div style="width:50px; position:absolute; height:30px; margin-top:-190px; margin-left:5px; ">
                        <a class="btn btn-danger sil" id="{{ $photo->id }}" href="#"> <span class="fa fa-trash fa"></span> </a>
                    </div>

                    <div style="width:100px; position:absolute; height:30px; margin-top:-190px; margin-left:60px;">
                        <a class="btn btn-primary" href="/admin/gallerys/edit/{{ $photo->id }}">  <i class="fa fa-pencil-square-o fa"></i> </a>
                    </div>

                    <div class="slogan" id="{{ $photo->id }}" style="width:100%; height:30px"> {{ $photo->name }} </div>

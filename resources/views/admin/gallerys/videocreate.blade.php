...
@section('content')
    ...
    <div class="panel-heading">
        <span class="panel-title hidden-xs"> Video Galeri  </span>
    </div>

    <form id="form" action="/admin/gallerys/videostore" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content pn br-n allcp-form theme-primary">
                    <div class="section row mbn">
                        ...
                        <div class="col-md-12 mb15 ph10">
                            ...
                            <textarea class="gui-textarea form-control" id="description" name="description" placeholder="Video Url"></textarea>
                        </div>

...
@section('content')
    ...
    <div class="panel" id="spy3">
        <div class="panel-heading">
            <span class="panel-title"> Siparişler </span>
            ...
            <div class="table-responsive">
                <table class="table footable  table-hover" data-page-navigation=".pagination" data-page-size="10">
                    ...
                    <tr  id="item-{{$order->id}}">
                        ...
                        <td>
                            <a class="btn btn-info" href="/admin/orders/cancel/{{ $order->id }}"> İptal Et </a>
                        </td>
                        <td><a class="btn btn-primary" href="/admin/orders/success/{{ $order->id }}"> Onayla </a> </td>

...
@section('content')
    ...
    <form id="form" action="/admin/submenus/galleryadd/{{ $menu->id }}" method="post" enctype="multipart/form-data">
        ...
        @foreach($gallerys as $gallery)
            <div id="item-{{ $gallery->id }}" class="col-lg-3">
                <div  style="width: 100% ; height:200px;  border: 1px solid #eee;">
                    <img class="gallerySirala" src="{{ asset("uploads/submenu/$gallery->img") }}" width="100%" height="200px">
                </div>

                <div style="width:50px; position:absolute; height:30px; margin-top:-200px; margin-left:5px; ">
                    <a style="color:red;" onclick="return siluyari();" href="{{ asset("/admin/submenus/gallerySil/$gallery->id") }}"> <span class="fa fa-trash fa-2x"></span> </a>
                </div>

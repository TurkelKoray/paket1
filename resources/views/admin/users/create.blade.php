...
@section('content')
    ...
    <form id="form" action="/admin/users/store" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content pn br-n allcp-form theme-primary">
                    <div class="section row mbn">
                        ...
                        <div class="col-md-12 mb15 ph10">
                            ...
                            <input name="name" type="text" class="gui-input form-control" value="{{ old("name") }}" placeholder="Yönetici Adı">
                            @if($errors->has("name"))
                        ...
                        <div class="col-md-12 mb15 ph10">
                            ...
                            <input name="email" type="text" class="gui-input form-control" value="{{ old("email") }}" placeholder="Yönetici Email">
                            @if($errors->has("email"))
                                <div style="margin-top: 5px" class="col-lg-12">
                                    <div class="alert alert-micro alert-warning alert-dismissable">
                                        {{ $errors->first("email") }}
                            ...
                            <div class="section">
                                <label class="field select">
                                    <select id="yetki" name="yetki">
                                        <option value="10">Yönetici</option>
                                    </select>
                                    <i class="arrow"></i>
                                </label>
                            </div>

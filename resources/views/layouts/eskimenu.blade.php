                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @foreach($menus as $menu)
                        ...
                        @if ($menu->submenus->count()>0)
                            @if($menu->type=="us")
                                <li>
                                    <a href="#SUB">ÜRÜNLER <i class="fa fa-caret-down"></i></a>
                                    <div class="submenu">
                                        <div class="submenu-in">
                                            <div class="row">
                                                <div class="col-sm-6 fitter">
                                                    <ul>
                                                        @foreach($menu->submenus as $submenu)
                                                            ...
                                                            @endphp
                                                            <li><a href="{{ url($sublink) }}" @if(!empty($submenu->headerimg)) data-image="{{ asset("uploads/submenu/".$submenu->headerimg) }}" @endif>{{$submenu->name}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                                <div class="col-sm-6 hidden-xs">
                                                    @foreach($menu->submenus as $submenu)
                                                        @if(!empty($submenu->headerimg))
                                                            <a class="istand fitter "><img src="{{ asset("uploads/submenu/".$submenu->headerimg) }}" class="center-block img-responsive" /></a>
                                                        @endif
                                                    @endforeach
                                                </div>

            ...
            @foreach($sliders as $slider)
                <li>
                    <div class="slide-image">
                        ...
                        <img src="{{ asset("uploads/slider/thumb/".$slider->img) }}" class="img-responsive btn-block visible-xs" />
                    </div>
                </li>
            @endforeach
        </ul>
                    ...
                    @foreach($homeShowProducts as $homeShowProduct)
                        @if(!empty($homeShowProduct->img))
                            <div class="col-md-4 col-sm-6">
                                <div class="home-box">
                                    <a href="{{ asset($homeShowProduct->productCategory->menu->slug."/".$homeShowProduct->productCategory->slug."/".$homeShowProduct->slug.".html") }}" class="home-box-link">
                                        <img src="{{ asset("uploads/products/thumb/".$homeShowProduct->img) }}" class="img-responsive btn-block" />
                                    </a>
                            ...
                            <ul>
                                @foreach($newsOurs as $newsOur)
                                    <li>
                                        ...
                                        <div class="text-right"><a href="{{ url($newsOur->url.".html") }}" class="btn-more"><i class="fa fa-chevron-right"></i></a></div>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
